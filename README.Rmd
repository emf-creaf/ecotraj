...
* Interpretation of trajectory **relative movements** (Djeghri et al. under review).
...
+ Djeghri N, Sturbois A, Hélaouët P, Geissmann Q, Rimmelin-Maury P, Boyé A, Gauthier O, De Cáceres M (2026). Going round in cycles but going somewhere: Deciphering cyclical dynamics using Ecological Trajectory Analysis. Ecological Monographs, 96(2), e70058 (https://doi.org/10.1002/ecm.70058).
