...
#' \emph{E. ciliaris}. This habitat is considered of community interest as part of the European
#' directive on the conservation of natural habitats and of wild fauna and flora (97/62/CEE). 
#' For the definition of the reference envelope, surveys integrated the variability
#' of reference states from youngest to early senescent stages, based on expert
#' assessment with respect to the European Directive (97/62/CEE) requirements.
#' 
#' The data set consists of 23 rows and 46 columns. 
