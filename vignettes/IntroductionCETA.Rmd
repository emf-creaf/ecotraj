...
However CETA provides a plotting function dedicated to fixed date trajectories that uses a circular color palette for the fixed dates trajectories and can represent the original cyclical trajectory:
```{r fig = TRUE, fig.height=5, fig.width=5, fig.align = "center"}
...
To be analyzed using ETA, the distance matrix has to be complemented with information regarding sites and surveys. 
```{r}
