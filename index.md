...
| [`averageTrajectories()`](https://emf-creaf.github.io/ecotraj/reference/transformTrajectories.md) | Creates an “average” trajectory where the position of each observation is the average of the position of the corresponding observations of the input trajectories. |
