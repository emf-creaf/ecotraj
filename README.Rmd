...
+ Djeghri et al (2026) Going round in cycles but going somewhere: Deciphering cyclical dynamics using Ecological Trajectory Analysis. Ecological Monographs (accepted).
