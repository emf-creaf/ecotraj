...
Package `ecotraj` is a package providing a framework to assist ecologists in the analysis of temporal changes in ecosystems defined on a chosen multivariate space. It is related to the following publications:
...
Package `ecotraj` can be found at [CRAN](https://cran.r-project.org/). In addition, the latest stable `ecotraj` R package can also be installed from GitHub as follows:
