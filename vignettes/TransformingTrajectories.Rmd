...
It is also possible to average a subset of the original trajectories, while keeping the remaining unaltered. For example, we average here the trajectories of sites `"2"` and `"3"`:
